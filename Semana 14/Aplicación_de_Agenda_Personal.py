...
class DatePicker(tk.Toplevel):
    def __init__(self, widget=None):
        ...
        self.geometry("320x320+650+350")  # ← MÁS ALTO para mostrar AÑO
        self.init_frames()
    ...
    def init_month_year_labels(self):
        ...
        self.year_lbl.grid(row=0, column=5, padx=8, pady=5)
        ...
        self.month_lbl.grid(row=0, column=1, padx=8, pady=5)
    ...
    def init_buttons(self):
        ...
        self.left_yr.grid(row=0, column=4, padx=2, pady=5)

        self.right_yr = tk.Button(self.frame1, text="Año ▶", command=self.next_year,
                                  bg="#D8BFD8", activebackground="#C8A8C8", activeforeground="#4B0082",
                                  relief="raised", borderwidth=3, font=('Arial', 9, 'bold'))
        self.right_yr.grid(row=0, column=6, padx=2, pady=5)
        ...
        self.left_mon = tk.Button(self.frame1, text="◀ Mes", command=self.prev_month,
                                  ...
                                  relief="raised", borderwidth=3, font=('Arial', 9, 'bold'))
        self.left_mon.grid(row=0, column=0, padx=2, pady=5)

        self.right_mon = tk.Button(self.frame1, text="Mes ▶", command=self.next_month,
                                   bg="#E6E6FA", activebackground="#D4D4F8", activeforeground="#4B0082",
                                   relief="raised", borderwidth=3, font=('Arial', 9, 'bold'))
        self.right_mon.grid(row=0, column=2, padx=2, pady=5)

    def space_between_widgets(self):
        self.frame1.grid_columnconfigure(3, minsize=20)
